...
class PemasukanHasilProduksiSeeder extends Seeder
{
    public function run()
    {
        DB::table('pemasukan_hasil_produksi')->insert([
            [
                'key_number' => 'PHP-2024-001', 'dokumen_nomor' => 'PROD-2024-001',
            ...
            [
                'key_number' => 'PHP-2024-002', 'dokumen_nomor' => 'PROD-2024-002',
            ...
            [
                'key_number' => 'PHP-2024-003', 'dokumen_nomor' => 'PROD-2024-003',
            ...
            [
                'key_number' => 'PHP-2024-004', 'dokumen_nomor' => 'PROD-2024-004',
            ...
            [
                'key_number' => 'PHP-2024-005', 'dokumen_nomor' => 'PROD-2024-005',
