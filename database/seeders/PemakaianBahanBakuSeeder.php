...
class PemakaianBahanBakuSeeder extends Seeder
{
    public function run()
    {
        DB::table('pemakaian_bahan_baku')->insert([
            [
                'key_number' => 'PBB-2024-001', 'no_pengeluaran' => 'OUT-2024-0001',
            ...
            [
                'key_number' => 'PBB-2024-002', 'no_pengeluaran' => 'OUT-2024-0002',
            ...
            [
                'key_number' => 'PBB-2024-003', 'no_pengeluaran' => 'OUT-2024-0003',
            ...
            [
                'key_number' => 'PBB-2024-004', 'no_pengeluaran' => 'OUT-2024-0004',
            ...
            [
                'key_number' => 'PBB-2024-005', 'no_pengeluaran' => 'OUT-2024-0005',
