            ...
            <div class="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-44 bg-white rounded-xl border border-slate-200 shadow-lg z-50">
                        ...
                        <a href="{{ route('reports.mutasi-hasil-produksi', array_merge(request()->query(), ['download' => 'xlsx'])) }}" class="block px-4 py-2.5 text-xs text-slate-600 hover:bg-green-50 hover:text-green-700 transition-colors rounded-t-xl">Microsoft Excel (.xlsx)</a>
                        <a href="{{ route('reports.mutasi-hasil-produksi', array_merge(request()->query(), ['download' => 'pdf'])) }}" class="block px-4 py-2.5 text-xs text-slate-600 hover:bg-green-50 hover:text-green-700 transition-colors rounded-b-xl">PDF Document (.pdf)</a>
                    </div>
                </div>
            </div>
                ...
                <table class="w-full text-left text-xs text-slate-600">
                    <thead class="bg-slate-50 font-bold font-montserrat text-[10px] tracking-wider text-slate-800">
                        <tr class="text-center">
                            ...
                            <th rowspan="2" class="px-4 py-3 align-middle">Bulan</th>
                            <th rowspan="2" class="px-4 py-3 align-middle">Tahun</th>
                        ...
                        <tr class="text-center">
                            ...
                            <th class="px-4 py-2 border-r border-slate-200/50 text-right">Lain-lain</th>
                            <th class="px-4 py-2 border-r border-slate-200/50 text-right">Pengeluaran</th>
                            <th class="px-4 py-2 text-right">Lain-lain</th>
                        </tr>
                    </thead>
